...
* *Eviter de transformer les flux ou d'implémenter des règles métier dans l'API Gateway, même si elle le permet.*

## Enjeux des API dans le contexte du Ministère de la Transition Écologique
...
## Solutions d'API Gateway aux Ministère de la Transition Écologique
