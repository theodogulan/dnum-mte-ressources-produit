...
* Les parcours à contrainte forte de performance (ex : réponse en moins de *x* secondes).
...
Un échange avec le [responsable métier](../../cadrer/les-differents-roles-et-metiers/responsable-metier.md) et/ou le [responsable produit](../../cadrer/les-differents-roles-et-metiers/responsable-produit.md) permet d'identifier les cas pertinents.
