...
* Pour les agents publics en administration centrale (Ministère de la Transition Écologique) ou gérés en central (ARS, DREETS), utiliser :
  * l’**entité d’appartenance renvoyée par ProConnect** au format DNUM/ST
...
3. **Déléguer la gestion des comptes partenaires**\
   La gestion des comptes partenaires (identités, rôles, habilitations) DEVRAIT être déléguée aux partenaires eux-mêmes, par exemple via les espaces partenaires d'EFPConnect, ProConnect.

/!\ Les annuaires AD du Ministère de la Transition Écologique ne contiennent ni rôles ni habilitations.
